...
sudo apt-get install -y libapache2-mod-php8.3 php8.3-common php8.3-ldap php8.3-zip php8.3-imap php8.3-intl php8.3-mbstring php8.3-mysql php8.3-pgsql php8.3-xml php8.3-gd php8.3-xmlrpc php8.3-curl php8.3-soap php8.3-sqlite3 php8.3-redis php-imagick &> /dev/null
